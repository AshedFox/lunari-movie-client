...
import { MovieReviewListItem } from '@entities/movie-review';
import { GetMovieReviewsQuery } from '@shared/api/graphql/graphql';
...
export const MovieReviewsList = ({ movieId, userId, queryRef }: Props) => {
