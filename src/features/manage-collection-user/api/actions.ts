...
export async function createCollectionUserAction(
  ...
  revalidateTag(`collections-${data.collectionId}-users`, 'max');
  updateTag(`collections-${data.collectionId}-users-${data.userId}`);
...
export async function updateCollectionUserAction(
  ...
  revalidateTag(`collections-${collectionId}-users`, 'max');
  updateTag(`collections-${collectionId}-users-${userId}`);
