...
import { createCollectionAction } from '../api/actions';
import { toast } from 'sonner';
import { AsyncMultiSelect } from '@shared/ui/multi-select';
import { useLazyQuery } from '@apollo/client/react';
import { useMemo } from 'react';
import { useRouter } from 'next/navigation';
import { zodResolver } from '@hookform/resolvers/zod';
import { createCollectionSchema } from '../model';
import { GetMoviesDocument } from '@shared/api/graphql/graphql';
...
export const CreateCollectionForm = () => {
  ...
  const onSubmit = (input: Input) => {
    toast.promise(
      async () => {
        const data = await createCollectionAction({
